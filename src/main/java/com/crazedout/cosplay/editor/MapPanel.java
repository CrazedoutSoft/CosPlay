...
public class MapPanel extends JPanel implements GamePanel {
    ...
    public void paintComponent(Graphics g){
        ...
        for(Tile t:map.grid){
            ...
            if(t.getFile()!=null && t.getFile().endsWith("blank.png") && showWalls){
