...
public class SpriteEditor {
    ...
    public boolean edit(MapPanel mp, Map map, Sprite sprite){
        ...
        sounds.setSelectedIndex(sprite.getContinuousSoundId());
        effects.setSelectedIndex(sprite.getEffectSoundId());
        ...
        if (option == JOptionPane.OK_OPTION) {
            try {
                ...
                if(r>0){
                    ...
                    sprite.setContinuousSoundId(sounds.getSelectedIndex());
                    sprite.setEffectSoundId(effects.getSelectedIndex());
