...
public class CosResources {
    ...
    private CosResources(){
        ...
        try{
            ...
            ex.printStackTrace();
            CosPlay.showErrorDialog("Error CosResource", ex.getMessage());
        }/*
        try{
            images.add(
                    new CosImageBitmap(
    ...
    private boolean checkForUserDir(){
        ...
        if(n==JOptionPane.YES_OPTION){
            try {
                ...
                CosPlay.showErrorDialog("Error UserDir",ex.getMessage());
            }
        }
        return false;
    }
    ...
    public void addFile(String file) {
        try {
            ...
            ex.printStackTrace();
            CosPlay.showErrorDialog("Error Add File", ex.getMessage());
        }
    }
    ...
    private void loadResorces(){
            try {
                if(exportRes) {
                    BufferedReader r =
                            new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("/files.txt")));
                    String line = null;
                    while ((line = r.readLine()) != null) {
                        l.beginLoading(null,line);
            ...
            ex.printStackTrace();
            CosPlay.showErrorDialog("Error loadRes", ex.getMessage());
        }
    }
