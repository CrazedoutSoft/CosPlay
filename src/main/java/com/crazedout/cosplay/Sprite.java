...
public abstract class Sprite implements Drawable, Movable, Serializable {
    ...
    protected int continuousSoundId, effectSoundId;
    ...
    public void setEffectSoundId(int id){
        this.effectSoundId=id;
    }

    public int getContinuousSoundId(){
        return this.continuousSoundId;
    }
